package com.yupi.lipicture.domain.picture.service.impl;
...
import com.yupi.lipicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.yupi.lipicture.infrastructure.manager.upload.FilePictureUpload;
import com.yupi.lipicture.infrastructure.manager.upload.PictureUploadTemplate;
import com.yupi.lipicture.infrastructure.manager.upload.UrlPictureUpload;
...
import com.yupi.lipicture.infrastructure.utils.ColorSimilarUtils;
import com.yupi.lipicture.infrastructure.utils.ColorTransformUtils;
...
//            }
        ...
        transactionTemplate.execute(status -> {
            ...
            if (finalSpaceId != null) {
                boolean update = spaceApplicationService.lambdaUpdate().eq(Space::getId, finalSpaceId).setSql("totalSize=totalSize+" + picture.getPicSize())
...
//            返回
        ...
        // 查询数据库
        Page<Picture> picturePage = pictureRepository.page(new Page<>(current, size),
