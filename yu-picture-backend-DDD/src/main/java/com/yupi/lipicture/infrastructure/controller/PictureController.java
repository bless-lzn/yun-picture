...
import com.yupi.lipicture.infrastructure.api.ImageSearch.ImageSearchApiFacade;
import com.yupi.lipicture.infrastructure.api.ImageSearch.model.ImageSearchResult;
import com.yupi.lipicture.infrastructure.api.aliyunai.AliYunAiApi;
import com.yupi.lipicture.infrastructure.api.aliyunai.model.CreateOutPaintingTaskResponse;
import com.yupi.lipicture.infrastructure.api.aliyunai.model.GetOutPaintingTaskResponse;
...
import com.yupi.lipicture.shared.auth.StpKit;
...
import com.yupi.lipicture.domain.picture.valueobject.PictureReviewStatusEnum;
import com.yupi.lipicture.interfaces.vo.picturevo.PictureTagCategory;
...
//    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    ...
    public BaseResponse<PictureVO> uploadPicture(PictureUploadRequest pictureUploadRequest,
        ...
        PictureVO pictureVO = pictureDomainService.uploadPicture(pictureUploadRequest, multipartFile, loginUser);
    ...
    public BaseResponse<PictureVO> uploadPictureByUrl(
        ...
        PictureVO pictureVO = pictureDomainService.uploadPicture(pictureUploadRequest, fileUrl, loginUser);
        return ResultUtils.success(pictureVO);
    }
    ...
    public BaseResponse<Integer> uploadPictureByBatch(
        ...
        User loginUser = userDomainService.getLoginUser(request);
        int uploadCount = pictureDomainService.uploadPictureByBatch(pictureUploadByBatchRequest, loginUser);
...
//    }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPage(@RequestBody PictureQueryRequest pictureQueryRequest, HttpServletRequest request) {
        ...
        // 查询数据库
        Page<Picture> picturePage = pictureApplicationService.page(new Page<>(current, size), pictureDomainService.getQueryWrapper(pictureQueryRequest));
        // 获取封装类
        return ResultUtils.success(pictureDomainService.switchPictureVOPage(picturePage));
    }
    ...
    public BaseResponse<List<PictureVO>> searchPictureByColor(@RequestBody SearchPictureByColorRequest searchPictureByColorRequest, HttpServletRequest request) {
        ...
        User loginUser = userDomainService.getLoginUser(request);
        List<PictureVO> result = pictureDomainService.searchPictureByColor(spaceId, picColor, loginUser);
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        // 获取封装类
        return ResultUtils.success(pictureDomainService.getPictureVOPage(pictureQueryRequest, request));
    }
...
//    }
    ...
    public BaseResponse<Boolean> editPicture(@RequestBody PictureEditRequest pictureEditRequest, HttpServletRequest request) {
        ...
        pictureDomainService.editPicture(pictureEditRequest, userDomainService.getLoginUser(request));
    ...
    public BaseResponse<CreateOutPaintingTaskResponse> createPictureOutPaintingTask(@RequestBody CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest, HttpServletRequest request) {
        ...
        User loginUser = userDomainService.getLoginUser(request);
        CreateOutPaintingTaskResponse response = pictureDomainService.createOutPaintingTask(createPictureOutPaintingTaskRequest, loginUser);
