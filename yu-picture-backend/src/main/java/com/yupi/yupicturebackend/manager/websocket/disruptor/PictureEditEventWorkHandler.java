...
//        PictureEditRequestMessage pictureEditRequestMessage = JSONUtil.toBean(message.getPayload(), PictureEditRequestMessage.class);
        ...
        switch (pictureEditMessageTypeEnum) {
            ...
            case EDIT_ACTION:
                ...
                break;
            default://错误信息仅仅发送给自己
                PictureEditResponseMessage pictureEditResponseMessage = new PictureEditResponseMessage(PictureEditMessageTypeEnum.ERROR.getValue(), "未知操作", null, userService.getUserVO(user));
